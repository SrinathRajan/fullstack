      ...
      <div>
        <div className="video-container">
          ...
          {/* <iframe
            ...
            allowFullScreen
          ></iframe> */}
          <iframe width="100%" height="639" src="https://www.youtube.com/embed/IU6k-4rKf-g" title="Learn How to Play Chess for Beginners in Less Than 8 Minutes"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> </div>
        ...
        <h1 style={{color:'black',fontSize:'25px'}}>Description</h1>
          ...
          <button style={{color:'black',backgroundColor:'green'}}onClick={handleEnroll}>Apply Now</button>
        </div>
        <footer style={footerStyle}>
      <div className="footer-container">
        <div className="footer-section">
          <h4>About Us</h4>
          <p>Our Chess Academy is dedicated to providing innovative courses and solutions...</p>
        </div>
        <div className="footer-section">
